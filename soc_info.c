...
/*
 * H713 uses SRAM A2 at 0x100000 instead of SRAM A1/C like H616.
 * SPL is loaded at 0x104000, with FEL scratch and swap buffers in SRAM A2.
 */
...
soc_info_t soc_info_table[] = {
	{
		...
		.name         = "H713",
		.spl_addr     = 0x104000, /* H713 uses SRAM A2 + 0x4000 */
